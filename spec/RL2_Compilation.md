...
| `SentinelMisuse` | `type` | `rl2:anyAgent`/`rl2:anyAsset` appears as a collection member. (Sentinel misuse in a Request field is rejected by the `Request` interchange schema, §7, not by `compile`.) |
