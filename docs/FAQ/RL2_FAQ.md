...
> **SCOPE-2 alignment in progress.** Answers that require persistent state, event sourcing, Cases,
> Requirements, protocol workflows, or a prescribed IR describe former or future work. The current
> boundary is defined in [`spec/RL2_Scope.md`](../../spec/RL2_Scope.md).
...
Each canonical clause contains exactly one Norm or Promise constructor, such as a Privilege,
Prohibition, Duty, Claim, Power, Liability, Immunity, or Promise.
...
- Canonical projection to the abstract syntax interpreted by the formal semantics
...
No. RL2 normatively defines canonical projection and observable evaluation meaning, not an
implementation IR or execution engine. A conforming implementation may interpret the canonical
AST directly, compile it, generate code, or use another verified representation, provided its
results match the semantic conformance suite. Reference-evaluator ideas are retained under
...
See: [RL2 References](../RL2_References.md) — glossary entries and [von Wright 1963], [Brown 2013]
...
See: [check-signing-sod.md](../../conformance/usecases/check-signing-sod.md),
[break-glass.md](../../conformance/usecases/break-glass.md)
...
2. Study the [use cases](../../conformance/usecases/README.md) for concrete examples
3. Reference [rl2.ttl](../../spec/rl2.ttl) and
   [RL2 Vocabulary](../RL2_Vocabulary.md) for the ontology specification

### Where can I find example policies?

The `conformance/usecases/` directory contains worked examples including:
...
|----------|-------------|
| [RL2 Primer](../RL2_Primer.md) | Tutorial introduction |
| [rl2.ttl](../../spec/rl2.ttl) | Core ontology (OWL) |
| [rl2-shacl.ttl](../../spec/rl2-shacl.ttl) | SHACL validation shapes |
| [RL2 Semantics](../../spec/RL2_Semantics.md) | Formal evaluation semantics |
| [RL2 References](../RL2_References.md) | Bibliography and glossary |
