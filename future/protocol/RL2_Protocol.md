...
version: "0.6"
status: "Future work — outside RL2 core conformance"
date: 2026-07-24
---

> **SCOPE-2 status:** This document is retained as a possible future companion protocol. Cases,
> Requirements, event sourcing, re-evaluation workflows, and persistence are not part of the
> normative RL2 language. Core definitions that currently appear here will be extracted into the
> SCOPE-2 model and semantics before this document is revised further.
