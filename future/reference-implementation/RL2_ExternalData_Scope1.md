---
title: "RL2 External Data Integration — SCOPE-1 Reference"
subtitle: "Source Binding, Interaction Modes, and the Pure-Evaluator Boundary"
version: "0.1"
status: "Historical reference implementation design — outside RL2 core conformance"
date: 2026-07-29
---

# RL2 External Data Integration

> **SCOPE-2 status:** This document preserves the former SourceBinding, live-resolution,
> ContextManifest, and interaction-mode design. These are not normative language requirements.
> Active external-data guidance is `../../docs/RL2_ExternalData.md`; the normative snapshot
> boundary is `../../spec/RL2_Model.md`.

> **SCOPE-2 alignment in progress.** The normative core consumes an immutable `WorldSnapshot` and
> performs no live I/O during evaluation (`../spec/RL2_Model.md`). Source registries, live
> resolution, iterative interaction, manifests, and fetching behavior below are retained as
> informative implementation ideas until they move to `../future/reference-implementation/`.
