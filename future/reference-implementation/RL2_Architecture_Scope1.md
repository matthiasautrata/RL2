---
title: "RL2 Architecture — SCOPE-1 Reference"
subtitle: "Functional Model, Evaluation Pipeline, and Design Rationale"
version: "0.6"
status: "Historical reference implementation architecture — outside RL2 core conformance"
date: 2026-07-24
---

# RL2 Architecture

> **SCOPE-2 status:** This is the preserved pre-SCOPE-2 architecture. Compiler artifacts, live
> resolution, protocol wrapping, Cases, effects, and commit behavior are not normative RL2
> language requirements. The active informative architecture is
> `../../docs/RL2_Architecture.md`.

> **SCOPE-2 alignment in progress.** This is an informative document. The normative architecture
> is the pure evaluation boundary in `../spec/RL2_Model.md`. Sections below that prescribe context
> materialization, protocol wrapping, Cases, state persistence, effects, or commits describe the
> former SCOPE-1 design and will be reduced or moved to `../future/`.
...
For formal semantics, see `../spec/RL2_Semantics.md`. Retained protocol research is under
`../future/protocol/` and is not part of the core language architecture.
