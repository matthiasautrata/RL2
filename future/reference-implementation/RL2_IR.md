...
version: "0.8"
status: "Reference implementation idea — outside RL2 core conformance"
date: 2026-07-29
---

# RL2 Intermediate Representation

> **SCOPE-2 status:** This document is retained as a possible reference-evaluator design, not as
> a normative RL2 compilation target. Canonical RDF-to-AST projection remains core language work
> and will be extracted into `spec/`; indexes, effects, commit behavior, and evaluator architecture
> are follow-on implementation topics.
...
**SCOPE-1**, `../../project/issues.md`). For the formal semantics this IR refines, see
`../../spec/RL2_Semantics.md`; for the architectural pipeline, `../../docs/RL2_Architecture.md`;
`../research/design-forth-ir.md`
